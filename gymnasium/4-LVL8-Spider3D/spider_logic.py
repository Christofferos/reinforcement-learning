    ...
    * v0: Initial versions release
    ...
    def __init__(
        ...
        **kwargs,
        ...
        xml_path = os.path.join(os.path.dirname(__file__), "spider.xml")
    ...
    def step(self, action):
        ...
        DEFAULT_HEIGHT = 0.65
        Z_POS_OFFSET = z_position_after - DEFAULT_HEIGHT
        # MEAN_Z_X_VELOCITY = (z_velocity + x_velocity)/2
        jump_reward = np.clip(z_velocity, 0, 1) + np.clip(Z_POS_OFFSET, 0, 1) # 0.75 and 0.5

        x_position_after, _ = xy_position_after
