...
class HumanoidParkourEnv(MujocoEnv, utils.EzPickle):
    ...
    def _get_obs(self, horizontal_velocity):
        ...
        vector_to_target_2 = self.next_target_point_xyz - current_agent_xyz
        ...
        return np.concatenate(
            [
                ...
                vector_to_target_1,
                vector_to_target_2,
                self.previous_action, # QUestionable
                forward_vec, # QUestionable
                up_vec # QUestionable
            ]
        )
    ...
    def _get_ray_data(self, horizontal_vel):
        ...
        for i in range(self.num_rays):
            ...
            local_offset = np.array([
                self.line_x_offset + i * self.line_x_spacing,
                0, # Centered on the Y-axis
                self.line_z_offset # This is now 0.0
            ])
        ...
        return distances, ray_start_positions, ray_dir
